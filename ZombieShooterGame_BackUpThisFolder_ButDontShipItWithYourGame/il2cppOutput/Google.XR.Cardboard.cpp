...
struct InputControl_1_t2BE808A88535A7BD02A4623F3798E6FCDAE1F21E  : public InputControl_t74F06B623518F992BF8E38656A5E0857169E3E2E
{
	...
	InlinedArray_1_t3C09CF0FF8AFDDAE359F6963D9448B01EBD0F9D1 ___m_ProcessorStack_24;
...
// System.Boolean CardboardReticlePointer::IsInteractive(UnityEngine.GameObject)
...
// UnityEngine.InputSystem.Controls.TouchControl Google.XR.Cardboard.Api::GetFirstTouchIfExists()
...
// System.Void Google.XR.Cardboard.Api::CardboardUnity_setHeadTrackerLowPassFilter(System.Int32)
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CardboardReticlePointer_Update_mDA81EA31248FBC24583F8E10E277647019954CFB (CardboardReticlePointer_t9A831A87CC4F4E8308410F73B91A763941ED0A3F* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		bool L_10;
		L_10 = CardboardReticlePointer_IsInteractive_m67CD7CE89D31D3A8864D6DDCBC18A6D5AE7063E4(__this, L_9, NULL);
		if (!L_10)
		{
			goto IL_0064;
		}
...
IL_0064:
	{
		...
		__this->____gazedAtObject_14 = L_14;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____gazedAtObject_14), (void*)L_14);
		// if (IsInteractive(_gazedAtObject))
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_15 = __this->____gazedAtObject_14;
		bool L_16;
		L_16 = CardboardReticlePointer_IsInteractive_m67CD7CE89D31D3A8864D6DDCBC18A6D5AE7063E4(__this, L_15, NULL);
		if (!L_16)
		{
			goto IL_0094;
		}
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_17 = __this->____gazedAtObject_14;
		NullCheck(L_17);
		GameObject_SendMessage_m65848D6A8F999FACBC1C21B7303660B7AFF6674E(L_17, _stringLiteral7892A84274C1DC4A2351A49903EB298DEA99C240, NULL);
	}
...
IL_0094:
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_19 = __this->____gazedAtObject_14;
		bool L_20;
		L_20 = CardboardReticlePointer_IsInteractive_m67CD7CE89D31D3A8864D6DDCBC18A6D5AE7063E4(__this, L_19, NULL);
		CardboardReticlePointer_SetParams_m0A0EA80939328F34E54DA53C75C9FBB0E85EE572(__this, L_18, L_20, NULL);
		goto IL_00e0;
	}
...
IL_00af:
	{
		...
		bool L_22;
		L_22 = CardboardReticlePointer_IsInteractive_m67CD7CE89D31D3A8864D6DDCBC18A6D5AE7063E4(__this, L_21, NULL);
		if (!L_22)
		{
			goto IL_00d3;
		}
...
IL_00c9:
	{
		NullCheck(G_B12_0);
		GameObject_SendMessage_m65848D6A8F999FACBC1C21B7303660B7AFF6674E(G_B12_0, _stringLiteralB81A1EDFC9FCE7D754F9199BAED4FF1E125B0C7E, NULL);
	}
...
IL_00e0:
	...
	{
		// if (IsInteractive(_gazedAtObject))
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_26 = __this->____gazedAtObject_14;
		bool L_27;
		L_27 = CardboardReticlePointer_IsInteractive_m67CD7CE89D31D3A8864D6DDCBC18A6D5AE7063E4(__this, L_26, NULL);
		if (!L_27)
		{
			goto IL_010b;
		}
...
IL_0101:
	{
		NullCheck(G_B18_0);
		GameObject_SendMessage_m65848D6A8F999FACBC1C21B7303660B7AFF6674E(G_B18_0, _stringLiteralE4D1D91E707649742B086EDB3E0F4EFA9754545A, NULL);
	}
...
IL_0031:
	{
		...
		Nullable_1__ctor_m141FA88563AC0B5179132FB929EABD02C47FF703((&L_8), ((int32_t)(1<<((int32_t)(L_7&((int32_t)31))))), /*hidden argument*/Nullable_1__ctor_m141FA88563AC0B5179132FB929EABD02C47FF703_RuntimeMethod_var);
		G_B6_0 = L_8;
	}
...
IL_0042:
	{
		V_2 = G_B6_0;
		LayerMask_t97CB6BDADEDC3D6423C7BCFEA7F86DA2EC6241DB L_9 = __this->___ReticleInteractionLayerMask_5;
		int32_t L_10;
...
IL_0064:
	{
		...
		Nullable_1__ctor_m141FA88563AC0B5179132FB929EABD02C47FF703((&L_15), ((int32_t)(L_13&L_14)), /*hidden argument*/Nullable_1__ctor_m141FA88563AC0B5179132FB929EABD02C47FF703_RuntimeMethod_var);
		G_B9_0 = L_15;
	}
...
IL_0072:
	{
		...
		return (bool)((((int32_t)((int32_t)(((((int32_t)L_16) == ((int32_t)L_17))? 1 : 0)&(int32_t)L_18))) == ((int32_t)0))? 1 : 0);
	}
}
...
IL_0009:
	{
		...
		L_1 = Api_GetFirstTouchIfExists_m539D70B561966EE2B1C4D8A4015ECA8A1558C47C(NULL);
		V_0 = L_1;
		// if (touch == null)
...
IL_0014:
	{
		...
		L_6 = Vector2Int_RoundToInt_m3105CCF1283211D549DEB4C84AEEB1D8034E7A4E_inline(L_5, NULL);
		V_1 = L_6;
	...
	}
	{
		...
		L_10 = Widget_get_CloseButtonRect_mA6D29E2FF35B9D6C85EA22F321C44B22D32E5879(NULL);
		V_2 = L_10;
		Vector2Int_t69B2886EBAB732D9B880565E18E7568F3DE0CE6A L_11 = V_1;
		bool L_12;
		L_12 = RectInt_Contains_mCBF3E53C9D20BB9268453754AA93BCA581461493((&V_2), L_11, NULL);
		return L_12;
	}
...
IL_0014:
	...
	}
	{
		...
		L_13 = Widget_get_GearButtonRect_mA17BB60F3BCD3D84382AED3F12E0BB0C077440D0(NULL);
		V_2 = L_13;
		Vector2Int_t69B2886EBAB732D9B880565E18E7568F3DE0CE6A L_14 = V_1;
		bool L_15;
		L_15 = RectInt_Contains_mCBF3E53C9D20BB9268453754AA93BCA581461493((&V_2), L_14, NULL);
...
IL_0014:
	...
	}
	{
		...
		L_11 = Widget_get_CloseButtonRect_mA6D29E2FF35B9D6C85EA22F321C44B22D32E5879(NULL);
		V_4 = L_11;
		Vector2Int_t69B2886EBAB732D9B880565E18E7568F3DE0CE6A L_12 = V_1;
		bool L_13;
		L_13 = RectInt_Contains_mCBF3E53C9D20BB9268453754AA93BCA581461493((&V_4), L_12, NULL);
		if (L_13)
		{
			goto IL_006c;
		}
	}
	{
		...
		L_14 = Widget_get_GearButtonRect_mA17BB60F3BCD3D84382AED3F12E0BB0C077440D0(NULL);
		V_4 = L_14;
		Vector2Int_t69B2886EBAB732D9B880565E18E7568F3DE0CE6A L_15 = V_1;
		bool L_16;
		L_16 = RectInt_Contains_mCBF3E53C9D20BB9268453754AA93BCA581461493((&V_4), L_15, NULL);
		if (L_16)
		{
			goto IL_006c;
		}
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var);
		((Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_StaticFields*)il2cpp_codegen_static_fields_for(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var))->____startTouchStamp_4 = ((double)L_17);
		// _touchStarted = true;
...
IL_006c:
	...
	{
		il2cpp_codegen_runtime_class_init_inline(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var);
		bool L_19 = ((Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_StaticFields*)il2cpp_codegen_static_fields_for(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var))->____touchStarted_3;
		if (!L_19)
		{
			goto IL_0094;
		}
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var);
		double L_21 = ((Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_StaticFields*)il2cpp_codegen_static_fields_for(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var))->____startTouchStamp_4;
		double L_22;
		L_22 = Api_get_MinTriggerHeldPressedTime_m3D490337AA692D8628C5BEA15F57461FF9D80D98_inline(NULL);
		if ((!(((double)((double)il2cpp_codegen_subtract(((double)L_20), L_21))) > ((double)L_22))))
		{
			goto IL_008c;
		}
	}
...
// System.Void Google.XR.Cardboard.Api::SetLowPassFilter(System.Int32)
...
IL_0012:
	{
		...
		int32_t L_1 = ___0_velocity_filter_cutoff_frequency;
		il2cpp_codegen_runtime_class_init_inline(Api_t145FCB8AD359667011C398E3BE4F2962C25C363D_il2cpp_TypeInfo_var);
		Api_CardboardUnity_setHeadTrackerLowPassFilter_m33CE538599B875B0DBC21937A38C0FD72C6B1A9E(L_1, NULL);
		// }
		return;
	}
}
...
{
	{
		...
		TouchPhaseControl_t4652C6E0EBFAFA85A31607769876B02C1C9FCAEC* L_0 = __this->___U3CphaseU3Ek__BackingField_35;
		return L_0;
	}
}
IL2CPP_MANAGED_FORCE_INLINE IL2CPP_METHOD_ATTR double Api_get_MinTriggerHeldPressedTime_m3D490337AA692D8628C5BEA15F57461FF9D80D98_inline (const RuntimeMethod* method) 
